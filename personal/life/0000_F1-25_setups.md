...
* black, 100, orange, black, black+100, orange
* R 28.5 24.5 22
* aero 20 25
* 80 55
* 41 10 15 9 20 48
...
* Lift at 50 engine break down to 2nd
  * red
    * Stay in 6th, down to 4th at left red
      * Around in 3rd
        * red 3rd
          * 125
            * 50
* Pressures 27.5, 27.5, 23.5, 24.5
* aero 20 20
* 80 55
* 38 10 10 10 22 46
* default underfueled
...
* 150
  * added road strip on left
    * street addon (must clip curb on left)
      * left red plus plus
        * over the line as the left corner breaks
          * 90m
            * must clip curbs left right left
              * break at yellow sign
                * break short of under the sign
...
* Shit setup
* undercut
* added road, around in 4th
  * 50 down to 6th, immediately down to 3rd
  * 50 down to 2nd
    * 50 down to 5th
    * dont clip inner corner but break right after
      * start of trim,around in 3rd
        * 100 down to 3rd
          * as soon as shift to 4rd brake
* aero 32 38
* diff 70 20
* suspension 40 5 10 10 25 50
* 23, 27.5, L, L

### Monaco

* Always rains it seems
* DRY setup below
  * 48 50 aero
  * 10 50
  * 40 6 14 10 22 50
...
* between last 2 banners
* last sponsorship banner, down to 3rd
* when accelerate, brake down to 2nd
* 100 down to 1st
* out of tunnel at red down to 2nd
* down to 3rd after black tarmac
* around sweeps in 5th, down to 3rd for corner
* down to 1st before ubs
* SUPER slow last 2 corners
...
* 41 1 2 15 20 45
* R R L L
* 100 4th, between two reds 3rd, red 2nd, 75 4th into 5th, apex 3rd, line 3rd
